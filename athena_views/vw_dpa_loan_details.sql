-- ============================================================================
-- VIEW: DPA Loan Details (Drill-down Report)
-- Report: Individual loan details for DPA closings
-- ============================================================================
-- Usage: SELECT * FROM arrive_home.vw_dpa_loan_details WHERE closing_year = 2026;
-- ============================================================================

CREATE OR REPLACE VIEW arrive_home.vw_dpa_loan_details AS
SELECT 
    -- Time dimensions
    ...
    -- Product info
    l.product_type AS dpa_program_name,
    ...
    CAST(s.clear_to_close_at AS DATE) AS clear_to_close_date,
